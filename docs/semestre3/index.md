...
- **[TP 24](bloc2/tp/tp24-suivi-mlflow.md), [TP 25](bloc2/tp/tp25-servir-modele-cluster.md), [TP 26](bloc2/tp/tp26-dag-airflow.md) et 27** : instrumentation MLflow, API de serving déployée sur le cluster du S2, DAG complet d'entraînement, chaîne intégrée « CD du modèle ».
