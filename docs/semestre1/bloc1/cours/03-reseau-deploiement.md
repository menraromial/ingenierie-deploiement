---
title: "Ch. 3 : Le réseau pour le déploiement"
sidebar_label: "Ch. 3 : Le réseau pour le déploiement"
hide_title: true
---
...
<ChapterHead
  kicker="Semestre 1 · Bloc 1 · Chapitre 3"
  title="Le réseau pour le déploiement"
  lecture="10 min"
/>
...
<Figure src="requete-https" num="3.1" alt="Diagramme de séquence entre navigateur, résolveur DNS et serveur Nginx : résolution DNS, poignée de main TCP en trois temps, négociation TLS, requête et réponse HTTP.">
  Anatomie d'une requête HTTPS en huit étapes, regroupées en quatre couches. Chaque couche peut échouer indépendamment : c'est la grille de lecture de tout diagnostic réseau.
</Figure>
...
:::exemple[Exemple travaillé : lire une erreur de connexion]
...
<Figure src="nat-virtualbox" num="3.2" alt="Sur le poste hôte, le terminal se connecte à 127.0.0.1:2222 ; le NAT de VirtualBox redirige vers 10.0.2.15:22 dans la VM, où écoute sshd.">
  La redirection de port du NAT VirtualBox, telle que vous l'utilisez dès le TP 1. La VM n'est pas joignable directement : seul le port redirigé traverse la frontière.
</Figure>
...
<Figure src="chaine-certificats" num="3.3" alt="Trois certificats empilés : la CA racine auto-signée signe la CA intermédiaire, qui signe le certificat du site ; le navigateur vérifie la chaîne en partant de la feuille.">
  Chaîne de confiance X.509. Le navigateur ne connaît que la racine ; il remonte les signatures depuis le certificat feuille et vérifie aussi le nom et les dates de validité.
</Figure>
